...
CUDA_VISIBLE_DEVICES=0 python ../main_inf_chime9_mixit_all_face.py \
...
--backbone seanet \
--n_cpu 0 \
--init_model /net/midgar/work/nitsu/work/chime9/SEANet/configs/exps/seanet_chime9_mixit_all_half_ft_plusnull_max8_2_face/model/model_0147.model \
